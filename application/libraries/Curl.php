...
class Curl {
	...
	public function ssl($verify_peer = TRUE, $verify_host = 2, $path_to_ca_cert = NULL)
	//public function ssl($verify_peer = TRUE, $verify_host = 2, $path_to_ca_cert = NULL, $path_to_cert = NULL, $path_to_key = NULL)
	{
		if ($verify_peer)
		{
			//$path = getcwd().'/certs/keystore';
			//$path = '/etc/ssl/certs/keystore';
			//$path = $path_to_cert;
			...
			$this->option(CURLOPT_CAINFO, $path_to_ca_cert);
			//$this->option(CURLOPT_CAPATH, getcwd().'/certs/');
			

			//$this->option(CURLOPT_HTTPAUTH, CURLAUTH_BASIC ) ;
			//$this->option(CURLOPT_USERPWD, "user:Password"); 

			//$this->option(CURLOPT_SSLCERT, $path_to_cert);
			//$this->option(CURLOPT_SSLKEY, $path);
			//$this->option(CURLOPT_SSLCERTPASSWD, 'Abd0s=Siddig!@');
		}
		else
		{
	...
	public function create($url)
	{
		...
		//$this->ssl(TRUE, 2, 'certs/certs.pem');
		//$this->ssl(TRUE, 2, getcwd().'/cert/cacert.pem', getcwd().'/cert/radiud_pem.pem',  getcwd().'/cert/radius.key');
