...
<?php include_once('header.php'); ?>       
  ...
  <section id="content">
	...
	<tr>
		<td class="top_left">
			مرحباً: <?=$this->session->userdata('username');?></td>
		<td class="top_right" style="width: 83%">
			<div id="menu-container">
				<!-- <ul id="navigationMenu">

				<li><a href="<?=site_url('portal/projects_management')?>" class="<?php if(($this->uri->segment(2) == "projects_management") or ($this->uri->segment(2)=='')) echo 'selectedMenu'; else echo 'normalMenu'?>">المشاريع</a></li>
				<li><a href="<?=site_url('portal/sites_management')?>" class="<?php if(($this->uri->segment(2) == "sites_management")) echo 'selectedMenu'; else echo 'normalMenu'?>">المواقع</a></li>
				<li><a href="<?=site_url('portal/users_management')?>" class="<?php if(($this->uri->segment(2) == "users_management")) echo 'selectedMenu'; else echo 'normalMenu'?>">المستخدمين</a></li>
				
				
				<li><a href="<?=site_url('portal/owners_management')?>" class="<?php if(($this->uri->segment(2) == "owners_management")) echo 'selectedMenu'; else echo 'normalMenu'?>">ملكية الموقع</a></li>
				<li><a href="<?=site_url('portal/sectors_management')?>" class="<?php if(($this->uri->segment(2) == "sectors_management")) echo 'selectedMenu'; else echo 'normalMenu'?>">القطاعات</a></li>
				<li><a href="<?=site_url('portal/regions_management')?>" class="<?php if(($this->uri->segment(2) == "regions_management")) echo 'selectedMenu'; else echo 'normalMenu'?>">المناطق</a></li>
				<li><a href="<?=site_url('portal/states_management')?>" class="<?php if(($this->uri->segment(2) == "states_management")) echo 'selectedMenu'; else echo 'normalMenu'?>">المحافظات</a></li>
				<li><a href="<?=site_url('portal/owner_types_management')?>" class="<?php if(($this->uri->segment(2) == "owner_types_management")) echo 'selectedMenu'; else echo 'normalMenu'?>">أنواع الملكيات</a></li>
				<li><a href="<?=site_url('portal/project_status_management')?>" class="<?php if(($this->uri->segment(2) == "project_status_management")) echo 'selectedMenu'; else echo 'normalMenu'?>">مراحل المشروع</a></li>
				<li><a href="<?=site_url('portal/site_types_management')?>" class="<?php if(($this->uri->segment(2) == "site_types_management")) echo 'selectedMenu'; else echo 'normalMenu'?>">أنواع المواقع</a></li>
				<li><a href="<?=site_url('portal/privileges_management')?>" class="<?php if(($this->uri->segment(2) == "privileges_management")) echo 'selectedMenu'; else echo 'normalMenu'?>">الصلاحيات</a></li>
				<li><a href="<?=site_url('portal/roles_management')?>" class="<?php if(($this->uri->segment(2) == "roles_management")) echo 'selectedMenu'; else echo 'normalMenu'?>">الأدوار</a></li>
				<li><a href="<?=site_url('portal/contract_types_management')?>" class="<?php if(($this->uri->segment(2) == "contract_types_management")) echo 'selectedMenu'; else echo 'normalMenu'?>">أنواع العقودات</a></li>
				<li><a href="<?=site_url('portal/contracts_management')?>" class="<?php if(($this->uri->segment(2) == "contracts_management")) echo 'selectedMenu'; else echo 'normalMenu'?>">العقودات</a></li>
				<li><a href="<?=site_url('portal/contract_categories_management')?>" class="<?php if(($this->uri->segment(2) == "contract_categories_management")) echo 'selectedMenu'; else echo 'normalMenu'?>">تصنيفات العقودات</a></li>
				<li><a href="<?=site_url('portal/contract_phases_management')?>" class="<?php if(($this->uri->segment(2) == "contract_phases_management")) echo 'selectedMenu'; else echo 'normalMenu'?>">مراحل العقود</a></li>
				</ul> -->

				<!-- <li><a href="<?=site_url('portal/consultants_management')?>" class="<?php if(($this->uri->segment(2) == "consultants_management")) echo 'selectedMenu'; else echo 'normalMenu'?>">المستشارون</a></li>
				<li><a href="<?=site_url('portal/contractors_management')?>" class="<?php if(($this->uri->segment(2) == "contractors_management")) echo 'selectedMenu'; else echo 'normalMenu'?>">المقاولون</a></li> -->
...
<ul class="modern-menu theme6" style="direction: rtl;">
			...
			<li>
				<a href="<?=site_url('portal/projects_management')?>"><span>المشاريع</span></a>
				<ul>
			...
			<li>
				<a href="<?=site_url('portal/sites_management')?>"><span>المواقع</span></a>
				<ul>
			...
			<li>
				<a href="<?=site_url('portal/contracts_management')?>"><span>العقودات</span></a>
				<ul>
					...
					<li><a href="<?=site_url('portal/contract_phase_category_list_management')?>"><span>قائمة العقودات</span></a></li>
				</ul>
			</li>
