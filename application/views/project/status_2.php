<?php 
	$crud->columns('name', 'started_date', 'close_date', 'contract_model_id','project_status_id', 'file');
	...
	$crud->fields('name', 'started_date', 'close_date','contract_model_id', 'project_status_id','file');
