<?php 
	$crud->columns('name', 'started_date', 'close_date', 'project_phase_id', 'file');
	...
	$crud->display_as('name', $this->lang->line('project_name'))
			...
			->display_as('file', $this->lang->line('tender_letter'));
	//fields will be displayed in add/edit form
	$crud->fields('name', 'started_date', 'close_date', 'project_status_id', 'file');
